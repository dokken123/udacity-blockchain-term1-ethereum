...
contract('StarNotary', accounts => { 
    ...
    describe('can create a star', () => { 
        it('can create a star and get its name', async function () { 
            ...
            await this.contract.createStar("Awesome Star!", "I love my Awesome star", "ra_032.155", "dec_121.874", "mag_245.978", tokenId, {from: accounts[0]})
    ...
    describe('buying and selling stars', () => { 
        ...
        beforeEach(async function () {
            await this.contract.createStar("Star power 104!", "I love my wonderful star 104", "ra_132.155", "dec_141.874", "mag_244.978", starId, {from: user1})
        })
